            ...
            <h1 className="text-blue text-xl tablet:hidden md:hidden font-semibold text-center mb-5 mt-5">Donatio</h1>
                ...
                <div className="md:w-[65%] tablet:w-[70%]  sm:w-full h-full bg-primary-200 rounded-[15px] px-5 py-10">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        <Input name="fullname" register={register} validator={validators['fullname']} label="Full name" placeholder="Your full name here" style="md:mt-10 tablet:mt-5" icon={<UserCircleIcon width={22} height={22} className="text-primary-900 mr-5" />}  />
                        <Input type="email" name="email" register={register} validator={validators['email']} label="Email" placeholder="Your email here" style="md:mt-9 tablet:mt-4" icon={<MailIcon width={22} height={22} className="text-primary-900 mr-5" />} />
                        ...
                        <div className="px-5">
                        <Button isLoading={mutation.isLoading} height='h-[40px]' label="Submit" backgroundColor="primary-900" textColor="white" width="w-full" isSubmit />
                        </div>
                    </form>
                    ...
                    <div className="flex flex-col justify-center items-center mt-5">
                        <a href="/login" className="text-primary-900 text-center text-sm">Already have an account?, Login</a>
                    </div>
                </div>
