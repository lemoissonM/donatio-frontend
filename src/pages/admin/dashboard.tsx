...
import volcano from "../../assets/images/volcano.jpeg"
    ...
    return (
        ...
        <div className="flex md:flex-row sm:flex-col justify-between md:mr-10">
            <div className="md:w-[65%] sm:w-full">
                ...
                {donation.isLoading ? <div className="flex flex-col items-center justify-center">
                ...
                <div className="md:grid md:grid-cols-2 w-100 md:gap-10 sm:flex sm:flex-row sm:overflow-x-scroll md:overflow-y-scroll md:max-h-[230px]">
                    {donation.data?.map( d => <div className="sm:w-[320px] sm:mr-4"><DonationItem donation={d} /></div>)}
                </div> }
            </div>
         <div className="md:w-[30%] sm:w-full">
         {donationCount.isLoading ? <div className="flex flex-col items-center justify-center">
                <LoadingIcon height={40} />
            ...
            <div className="bg-primary-200 px-4 py-8 rounded-[15px] w-full">
                ...
                <p className="lg:text-[40px] md:text-[25px] text-blue font-semibold mt-5">$ {donationCount?.data?.total.sum} </p>
            </div> 
            ...
            <div className="bg-secondary-100 px-4 py-8 rounded-[15px] w-full mt-10">
                ...
                <p className="lg:text-[40px] md:text-[25px] text-blue font-semibold mt-5">$ {donationCount?.data?.used.sum}</p>
            </div> 
