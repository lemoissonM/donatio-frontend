    ...
    <div className="flex flex-row bg-primary-200 rounded-[15px] p-3 sm:mb-6">
      ...
      <div className="pt-1 flex-grow px-4">
        ...
        <div className="flex flex-row justify-between">
          <p className="text-secondary-900 bg-secondary-300 w-[100px] rounded-[15px] text-sm pt-[4px] text-center font-semibold mt-[14px]">
            church
          </p>
          <button className="bg-primary-900 text-white text-sm h-[30px] w-[70px] mt-[12px] hover:bg-primary-700 rounded-[15px]">
            View
          </button>
        </div>
      </div>
