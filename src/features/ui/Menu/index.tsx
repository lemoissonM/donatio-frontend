...
const menus = [
  { value: 'Home', link: '/', icon: <HomeIcon width={22} className="mr-4" />, active: false },
  {
    ...
    link: '/needs/saved',
    icon: <SaveIcon width={22} className="mr-4" />,
    active: false,
  },
  {
    value: 'My donations',
    link: '/donations/me',
    icon: <HandIcon width={22} className="mr-4" />,
    active: false,
  },
  {
    value: 'My groups',
  ...
  },
  {
    value: 'Settings',
    link: '/settings',
    icon: <AdjustmentsIcon width={22} className="mr-4" />,
    active: false,
  },
];
...
const Menu: React.FC<PropTypes> = (props) => {
  ...
  return (
    <UserContext.Consumer>
      {(user) => (
        <aside
          className={`bg-primary-200 lg:w-[250px] md:w-[220px]  lg:m-10 md:my-10 md:mx-5 tablet:mx-4 rounded-[15px] h-5/6 z-30 sm:w-4/5 transition-transform ease-linear delay-300 sm:fixed ${
            !props.show ? 'sm:-translate-x-[110%]' : 'sm:translate-x-0'
          }`}
        >
